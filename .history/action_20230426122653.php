...
if($_POST['action'] == 'delete')
{
    ...
    try
    {
        ...
        while ($row = $stmt->fetch()) {
            ...
            $html .='<table width="100%" style="font-family: sans-serif;" cellpadding="10"> 
                    ...
                    <table width="100%" style="font-family: sans-serif; font-size: 14px;" >
                        <tr>
                            <td>
                                ...
                                <table width="20%" align="left" style="font-family: sans-serif; font-size: 14px;" >
                                    <tr>
                                        <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                    </tr>
                                </table>
                                <table width="30%" align="left" style="font-family: sans-serif; font-size: 14px;" >
                                    <tr>
                                        <td style=" padding: 0px 8px; line-height: 20px;"> <b>Ship To::</b> </br>'.$row['client_address'].' </td> 
                                    </tr> 
                                </table>
                            </td>
                        </tr>
                    ...
                    <table class="items" width="100%" style="border: 1px #eee solid; font-size: 14px; border-collapse: collapse;" cellpadding="8">
                        <thead>
                            <tr>
                                <td width="45%" style="border: 1px #eee solid;text-align: left;"><b>Product</b></td>
                                <td width="10%" style="border: 1px #eee solid;text-align: left;"><b>Code</b></td>
                                <td width="9%" style="border: 1px #eee solid;text-align: left;"><b>Pack</b></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0px; line-height: 20px;"><b>Payment for each invoice is due 30 days after</b> </td>
                                <td style="padding: 0px; line-height: 20px;"><b>delivery</b></td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
        ...
        $myfile = fopen( "hello_".$_POST["id"].".pdf, "w") or die("Unable to open file!");
        $txt = "John Doe\n";
        fwrite($myfile, $txt);
        $txt = "Jane Doe\n";
        fwrite($myfile, $txt);
        ...
        $client->convertStringToFile($html, "hello_".$_POST["id"].".pdf");
