            ...
            $html .='<table width="100%" style="font-family: sans-serif;" cellpadding="10"> 
                    ...
                    <table class="items" width="100%" style="border: 1px #eee solid; font-size: 14px; border-collapse: collapse;" cellpadding="8">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0px; line-height: 20px;">Thank you for your business.  </td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                            ...
                            <tr>
                                <td style="padding: 0px; line-height: 20px;">Payment for each invoice is due 30 days after </td>
                                <td style="padding: 0px; line-height: 20px;">30 days after delivery.</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td style="padding: 0px; line-height: 20px;">'.$row['invoice_tax_total'].'</td>
                            </tr>
                            <tr>
                                <td style=" padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                ...
                                <td style="padding: 0px; line-height: 20px;">'.$row['invoice_total'].'</td>
                            </tr>
