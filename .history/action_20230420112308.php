...
if($_POST['action'] == 'delete')
{
    ...
    try
    {
            ...
            $html .='<table width="100%" style="font-family: sans-serif;" cellpadding="10"> 
                        ...
                        <tr>
                            <td>
                                ...
                                <table width="40%" align="right" style="border: 1px #eee solid;font-family: sans-serif; font-size: 14px;" >
                                    <tr style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">
                                        <td style=" padding: 0px 8px; line-height: 20px;"><strong>Invoice '.$row['invoice_number'].'</strong></td>
                                     </tr>
                                    <tr  style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">
                                        <td style="  padding: 0px 8px; line-height: 20px;"><strong>Invoice Date:</strong></td>
                                        <td style="  padding: 0px 8px; line-height: 20px;">'.$row['date'].'</td>
                                    </tr>
                                    <tr  style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">
                                        <td style="  padding: 0px 8px; line-height: 20px;"><strong>Payment Terms:</strong></td>
                                        <td style="  padding: 0px 8px; line-height: 20px;">'.$row['invoice_tax_total'].'</td>
                                    </tr>
                                    <tr  style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">
                                        <td style="  padding: 0px 8px; line-height: 20px;"><strong>Due Date:</strong></td>
                                        <td style="  padding: 0px 8px; line-height: 20px;">'.$row['due_date'].'</td>
                                    </tr>
                                    <tr  style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">
                                        <td style="  padding: 0px 8px; line-height: 20px;"><strong>Amount Due:</strong></td>
                                        <td style="  padding: 0px 8px; line-height: 20px;">'.$row['invoice_total'].'</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
        ...
        <table class="items" width="100%" style="border: 1px #eee solid; font-size: 14px; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    <td width="15%" style="text-align: left;"><strong>Product</strong></td>
                    <td width="45%" style="text-align: left;"><strong>Code</strong></td>
                    <td width="10%" style="text-align: left;"><strong>Pack</strong></td>
                    <td width="10%" style="text-align: left;"><strong>Price</strong></td>
                    <td width="10%" style="text-align: left;"><strong>Qty</strong></td>
                    <td width="10%" style="text-align: left;"><strong>Total</strong></td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="padding: 0px 7px; line-height: 20px;"> </td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['size'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;"> </td>
                    <td style="padding: 0px 7px; line-height: 20px;"> </td>
                    <td style="padding: 0px 7px; line-height: 20px;"> </td>
                    <td style="padding: 0px 7px; line-height: 20px;"> </td>
                ...
                <tr>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['product'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['product_code'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['size'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['unit_price'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['quantity'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['total'].'</td>
                    <td style="padding: 0px 7px; line-height: 20px;">'.$row['invoice_total'].'</td>
                </tr> 
            </tbody>
        </table>
        <br>
