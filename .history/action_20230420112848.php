                        ...
                        <tr>
                            <td>
                                ...
                                <table width="40%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">Invoice '.$row['invoice_number'].'</td>
                                     </tr>
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">Invoice Date:'.$row['date'].'</td> 
                                    </tr>
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">Payment Terms:'.$row['invoice_tax_total'].'</td> 
                                    </tr>
                                    <tr>
                                        <td style=" border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">Due Date:'.$row['due_date'].'</td> 
                                    </tr>
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"">Amount Due:'.$row['invoice_total'].'</td> 
                                    </tr>
                                </table>
                            </td>
                        </tr>
