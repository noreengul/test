...
if($_POST['action'] == 'delete')
{
    ...
    try
    {
        ...
        <table width="100%" style="font-family: sans-serif;" cellpadding="10">
            <tr>
                <td width="49%"  >Name<br>Company Name<br>Area<br>Area 2<br>Kent<br>0123 6NN</td>
                <td width="2%">&nbsp;</td>
            ...
            <tr>
                <td>
                    ...
                    <table width="40%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                        <tr>
                            <td style="  padding: 0px 8px; line-height: 20px;"><strong>Booking Reference</strong></td>
                            <td style="  padding: 0px 8px; line-height: 20px;">XXXXXXXX</td>
                        </tr>
                        <tr>
