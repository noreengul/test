    ...
    try
    {
        ...
        <table width="100%" style="font-family: sans-serif;" cellpadding="10">
            <tr>
                ...
                <td width="2%">&nbsp;</td>
                <td width="49%" style=" text-align: right;"><b>Invoice Number</b><br>'.$row['invoice_number'].'<br> <b>Invoice Date</b><br>'.$row['date'].'<br> <b>Invoice Due Date</b><br>'.$row['due_date'].'   </td>
            </tr>
        </table>
        <br> 
        <br>
