...
if($_POST['action'] == 'delete')
{
    ...
    try
    {
        ...
        <table class="items" width="100%" style="border: 1px #eee solid; font-size: 14px; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    <td width="35%" style="border: 1px #eee solid;text-align: left;"><strong>Product</strong></td>
                    <td width="10%" style="border: 1px #eee solid;text-align: left;"><strong>Code</strong></td>
                    <td width="10%" style="border: 1px #eee solid;text-align: left;"><strong>Pack</strong></td>
                    <td width="10%" style="border: 1px #eee solid;text-align: left;"><strong>Price</strong></td>
                    <td width="10%" style="border: 1px #eee solid;text-align: left;"><strong>Qty</strong></td>
                    <td width="10%" style="border: 1px #eee solid;text-align: left;"><strong>Total</strong></td>
                    <td width="10%" style="border: 1px #eee solid;text-align: left;"><strong>Amount</strong></td> 
                </tr>
            </thead>
            <tbody>
                <tr>
