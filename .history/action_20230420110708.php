...
if($_POST['action'] == 'delete')
{
    ...
    try
    {
        ...
        <table width="100%" style="font-family: sans-serif;" cellpadding="10">
            <tr>
                <td width="49%"  >'.$row['client_address'].'  </td>
                <td width="2%">&nbsp;</td>
                <td width="49%" style="border: 1px #eee solid; text-align: right;"><b>Invoice Number</b>: '.$row['invoice_number'].'<br> <b>Invoice Date</b>:'.$row['date'].'<br> <b>Invoice Due Date</b> :'.$row['due_date'].'   </td>
            </tr>
        </table>
        <br> 
        ...
        <tr>
            <td>
                <table width="30%" align="left" style="font-family: sans-serif; font-size: 14px;" >
                    <tr>
                        <td style=" padding: 0px 8px; line-height: 20px;">'.$row['client_address'].' </br>'.$row['client_address'].' </td> 
                    </tr> 
                </table>
                <table width="30%" align="left" style="font-family: sans-serif; font-size: 14px;" >
                    <tr>
