                    ...
                    <table class="items" width="100%" style="border: 1px #eee solid; font-size: 14px; border-collapse: collapse;" cellpadding="8">
                        <thead>
                            <tr>
                                ...
                                <td width="13%" style="border: 1px #eee solid;text-align: left;"><b>Qty</b></td>
                                <td width="13%" style="border: 1px #eee solid;text-align: left;"><b>Total</b></td>
                                <td width="12%" style="border: 1px #eee solid;text-align: left;"><b>Amount</b></td> 
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                            ...
                            <tr>
                                <td style="border: 1px #eee solid;padding: 0px; line-height: 20px;">Thank you for your business.  </td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">Subtotal</td>
                                <td style="padding: 0px; line-height: 20px;">$'.$row['invoice_sub_total'].'</td>
                            </tr>
                            <tr>
                                <td style="border: 1px #eee solid;padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">Payment for each invoice is due 30 days after delivery.</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">Bottle Deposit</td>
                                <td style="padding: 0px; line-height: 20px;">$0.00 </td>
                            </tr>
                            <tr>
                                <td style="border: 1px #eee solid;padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                ...
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">Sales Tax Total</td>
                                <td style="padding: 0px; line-height: 20px;">$0.00'.$row['invoice_tax_total'].'</td>
                            </tr>
                            <tr>
                                <td style="border: 1px #eee solid;padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                ...
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">&nbsp;</td>
                                <td style="padding: 0px; line-height: 20px;">TOTAL</td>
                                <td style="padding: 0px; line-height: 20px;">$0.00'.$row['invoice_total'].'</td>
                            </tr>
