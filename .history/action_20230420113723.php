            ...
            <tr>
                <td>
                    ...
                    <table width="40%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                        ...
                        <tr>
                            <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"><strong>Bottle Deposit</strong></td>
                            <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">'.$row['date'].'</td>
                        </tr>
                        <tr>
                            <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;"><strong>Sales Tax Total</strong></td>
                            <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;">'.$row['date'].'</td>
                        </tr>
                        <tr>
