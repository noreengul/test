...
if($_POST['action'] == 'delete')
{
    ...
    try
    {
        ...
        <table width="100%" style="font-family: sans-serif;" cellpadding="10">
            <tr>
                <td width="49%"  ><b>Vendor</b>'.$row['vendor'].' <br> <b>Clinet</b>'.$row['client'].' <br> <b>Client Address</b>'.$row['client_address'].' <br> </td>
                <td width="2%">&nbsp;</td>
                <td width="49%" style=" text-align: right;"><strong>Invoice Number</strong><br>'.$row['invoice_number'].'<br>Country Name<br>123 456<br><br><strong>Telephone:</strong> +00 000 000 0000<br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br></td>
            </tr>
        </table>
        <br>
            ...
            <tr>
                <td>
                    ...
                    <table width="40%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                        <tr>
                            <td style="  padding: 0px 8px; line-height: 20px;"><strong>Invoice Number</strong></td>
                            <td style="  padding: 0px 8px; line-height: 20px;">'.$row['invoice_number'].'</td>
                        </tr>
                        <tr>
                            <td style=" padding: 0px 8px; line-height: 20px;"><strong>Lead Passenger</strong></td>
                            <td style="  padding: 0px 8px; line-height: 20px;">Pessenger Name</td>
                        </tr>
                        <tr>
                            <td style="  padding: 0px 8px; line-height: 20px;"><strong>Invoice Date</strong></td>
                            <td style="  padding: 0px 8px; line-height: 20px;">XX/XX/XXXX</td>
                        </tr>
                        <tr>
                            <td style=" padding: 0px 8px; line-height: 20px;"><strong>Balance Due Date</strong></td>
                            <td style="  padding: 0px 8px; line-height: 20px;">XX/XX/XXXX</td>
                        </tr>
                        <tr>
                            <td style="  padding: 0px 8px; line-height: 20px;"><strong>Departure Date</strong></td>
                            <td style="  padding: 0px 8px; line-height: 20px;">XX/XX/XXXX</td>
                        </tr>
                    </table>
                </td>
        ...
        <table class="items" width="100%" style="font-size: 14px; border-collapse: collapse;" cellpadding="8">
            <thead>
                <tr>
                    <td width="15%" style="text-align: left;"><strong>Invoice Number</strong></td>
