                        ...
                        <tr>
                            <td>
                                ...
                                <table width="40%" align="right" style="font-family: sans-serif; font-size: 14px;" >
                                    ...
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;""><strong>Invoice Date:</strong></br>'.$row['date'].'</td>
                                        <td style="  padding: 0px 8px; line-height: 20px;">'.$row['date'].'</td>
                                    </tr>
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;""><strong>Payment Terms:</strong></br>'.$row['invoice_tax_total'].'</td> 
                                    </tr>
                                    <tr>
                                        <td style=" border: 1px #eee solid; padding: 0px 8px; line-height: 20px;""><strong>Due Date:</strong></br>'.$row['due_date'].'</td> 
                                    </tr>
                                    <tr>
                                        <td style="border: 1px #eee solid; padding: 0px 8px; line-height: 20px;""><strong>Amount Due:</strong></br>'.$row['invoice_total'].'</td> 
                                    </tr>
                                </table>
                            </td>
                        </tr>
