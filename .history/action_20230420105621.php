    ...
    try
    {
        ...
        <table width="100%" style="font-family: sans-serif;" cellpadding="10">
            <tr>
                ...
                <td width="2%">&nbsp;</td>
                <td width="49%" style=" text-align: right;"><strong>Invoice Number</strong><br>'.$row['invoice_number'].'<br> <strong>Invoice Date</strong><br>'.$row['date'].'<br> Country Name<br>123 456<br><br><strong>Telephone:</strong> +00 000 000 0000<br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br><a href="#" target="_blank" style="color: #000; text-decoration: none;">companyname.com</a><br></td>
            </tr>
        </table>
        <br> 
        <br>
