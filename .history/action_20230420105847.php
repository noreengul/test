    ...
    try
    {
        ...
        <table width="100%" style="font-family: sans-serif;" cellpadding="10">
            <tr>
                ...
                <td width="2%">&nbsp;</td>
                <td width="49%" style=" text-align: right;"><b>Invoice Number</b><br>'.$row['invoice_number'].'<br> <strong>Invoice Date</strong><br>'.$row['date'].'<br> <strong>Invoice Due Date</strong><br>'.$row['due_date'].'   </td>
            </tr>
        </table>
        <br> 
        <br>
